...
if __name__ == "__main__":
    ...
    def step_one_new_hrm_streets():
        ...
        try:
            ...
            # Select in TRN_STREET_RIVA all records
    ...
    def step_two_update_retired_streets(trn_street_riva, local_gdb):
        ...
        if riva_retired_street_fdmids:
            ...
            with arcpy.da.UpdateCursor(trn_street_riva, ["FDMID", "DATE_RET", "DATE_REV", "OLD_FDMID", "SHAPE_LENGTH",
                                                         "DATE_ACT"]) as cursor:
    ...
    def step_three_updating_existing(trn_street_riva):
        ...
        trn_street_fdmids = {
            x[0]: {
                ...
                TRN_STREET,
                ["FDMID", "SHAPE@LENGTH", "FULL_NAME", "FROM_STR", "TO_STR", "GSA_LEFT", "OLD_FDMID", "DATE_ACT",
                 "SYS_DATE"],
            )
        }
